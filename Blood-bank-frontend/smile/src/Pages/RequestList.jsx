...
const RequestList = () => {
    ...
    const rejectRequest = async (id, sl) => {
        ...
        Swal.fire({
            ...
            if(res.isConfirmed){
                try {
                    const res = await axios.post('http://192.168.56.1:8000/adminUser/reject_request/',JSON.stringify({recipient_id : id}))
                    console.log(res)
                    Swal.fire({
    ...
    const acceptRequest = async (id) =>{
        console.log(id)
        try {
            const res = await axios.post('http://192.168.56.1:8000/adminUser/confirm_recipient_donation/', JSON.stringify({recipient_id : id}) )
            console.log(res)
    ...
    const getTableData = async () =>{
        setLoadingPage(true)
        try{
            const res = await axios.get('http://192.168.56.1:8000/adminUser/get_recipient_list/')
            console.log(res)
    ...
    const viewPrevDonation = async (id) => {
        ...
        console.log(id)
        try{
            const data = await axios.get('http://192.168.56.1:8000/adminUser/get_recipient_list/')
